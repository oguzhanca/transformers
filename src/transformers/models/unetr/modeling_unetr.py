...
# Base docstring
_CHECKPOINT_FOR_DOC = "monai/unetr"
...
UNETR_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "monai/unetr",
    # See all unetr models at https://huggingface.co/models?filter=unetr
]
...
@add_start_docstrings(
    "Unetr Model with a decoder on top for masked image modeling, as proposed in"
    " [SimMIM](https://arxiv.org/abs/2111.09886).",
    UNETR_START_DOCSTRING,
)
# Copied from transformers.models.vit.modeling_vit.ViTForMaskedImageModeling with VIT->UNETR,ViT->Unetr,vit->unetr,google/vit-base-patch16-224-in21k->monai/unetr
class UnetrForMaskedImageModeling(UnetrPreTrainedModel):
    ...
    def forward(
        ...
        >>> feature_extractor = ViTFeatureExtractor.from_pretrained("monai/unetr")
        >>> model = UnetrForMaskedImageModeling.from_pretrained("monai/unetr")
